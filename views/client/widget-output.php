...
if($use_default == 1) {
    //default output
    $output  = '<span class="taw-tutorials"><a title="' . esc_attr__('See all tutorials',TAW_TEXTDOMAIN) . '" href="' . esc_url( sprintf('http://fr.tuto.com/formateur/%s.htm', $apilogin) ) . '">' . __('tutorials : ', TAW_TEXTDOMAIN) . $stat['tutorials'] . '</a></span>';
